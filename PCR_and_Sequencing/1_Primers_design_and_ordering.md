...
1. To get to primer ordering page, select taps following this path: product -> Oligos & qPCR Probes -> Custom DNA -> Custome DNA Oligos -> Standard DNA Oligos -> Tubes **Order**. 
